...
food_1day = read.xport("./Dietary_foods_firstday_2015_16.XPT")
food_2day = read.xport("./Dietary_foods_secondday_2015_16.XPT")
nutrients_1day = read.xport("./Dietary_nutrients_firstday_2015_16.XPT")
nutrients_2day = read.xport("./Dietary_nutrients_secondday_2015_16.XPT")
supplements_1day = read.xport("./Dietary_supplements_firstday_2015_16.XPT")
supplements_2day = read.xport("./Dietary_supplements_secondday_2015_16.XPT")

## Code book demographics
demographics_labels = lookup.xport("./Demographics_2015_16.xpt")
...
write.csv(demographics_colnames, file = "./demographics.csv")

## Code book blood pressure
blood_pressure_labels = lookup.xport("./Blood_Pressure_2015_16.xpt")
...
write.csv(blood_pressure_colnames, file = "./blood_pressure.csv")


## Code book body measures (BMI)
BMI_labels = lookup.xport("./Body_measures_2015_16.xpt")
BMI_labels = BMI_labels$BMX_I
BMI_labels = BMI_labels$label

BMI_colnames = data.frame(colnames(BMI))
BMI_colnames[,2] = BMI_labels
write.csv(BMI_colnames, file = "./BMI.csv")


## Code book dietary food day 1
food_1day_labels = lookup.xport("./Dietary_foods_firstday_2015_16.xpt")
...
write.csv(food_1day_colnames, file = "./food_1day.csv")


## Code book dietary food day 2
food_2day_labels = lookup.xport("./Dietary_foods_secondday_2015_16.xpt")
...
write.csv(food_2day_colnames, file = "./Data_dictionary/food_2day.csv")


## Code book dietary nutrients day 1
nutrients_1day_labels = lookup.xport("./Dietary_nutrients_firstday_2015_16.xpt")
...
write.csv(nutrients_1day_colnames, file = "./Data_dictionary/nutrients_1day.csv")


## Code book dietary nutrients day 2
nutrients_2day_labels = lookup.xport("./Dietary_nutrients_secondday_2015_16.xpt")
...
write.csv(nutrients_2day_colnames, file = "./Data_dictionary/nutrients_2day.csv")


## Code book dietary supplements day 1
supplements_1day_labels = lookup.xport("./Dietary_supplements_firstday_2015_16.xpt")
...
write.csv(supplements_1day_colnames, file = "./Data_dictionary/supplements_1day.csv")

## Code book dietary supplements day 2
supplements_2day_labels = lookup.xport("./Dietary_supplements_secondday_2015_16.xpt")
...
write.csv(supplements_2day_colnames, file = "./supplements_2day.csv")
